"""Pydantic v2 schemas for GCP Cloud Billing API."""
...
class GCPCostRequest(BaseModel):
    """Request for GCP cost retrieval."""
...
class GCPServiceCost(BaseModel):
    """Cost breakdown for a single GCP service."""
...
class GCPCostResponse(BaseModel):
    """Normalized GCP cost response."""

    model_config = ConfigDict(extra="forbid")

    provider: Literal["gcp"] = Field(
        default="gcp",
    ...
    services: list[GCPServiceCost] = Field(
