...
export default function Dashboard() {
  ...
  const loadDashboard = useCallback(async () => {
    ...
    try {
      if (demoMode) {
        const demoData = getDemoDashboardData(range);
